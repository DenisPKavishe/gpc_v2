    ...
    <section className="py-20 max-w-7xl mx-auto px-4 mb-20">
      <div className="bg-primary rounded-2xl p-12 text-center text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            to="/community"
            className="bg-white text-primary px-8 py-3 rounded-xl font-bold hover:bg-slate-100 transition-colors"
          >
            Become a Volunteer
          </Link>
          <Link
            to="/donate"
            className="bg-primary/20 border border-white/30 px-8 py-3 rounded-xl font-bold hover:bg-white/10 transition-colors"
          >
            Make a Donation
          </Link>
        </div>
