  ...
  const needs = [
    {
      ...
      description: 'Aiming to collect 500 high-quality blankets for local shelters before the first freeze.',
    ...
    },
    {
      ...
      description: 'Backpacks, notebooks, and stationary for students in our mentorship program.',
    ...
    },
    {
      ...
      title: 'Fresh Produce',
      icon: 'nutrition',
      location: 'East End Community',
      childrenSupported: 200,
      description: 'Supporting our weekly community kitchen with fresh vegetables and fruits.',
